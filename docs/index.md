...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="cube-timer/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

</head>
<script src="cube-timer/scripts.js"></script>
<body onload="initialize()">
  ...
  <script src="cube-timer/vendor/jquery/jquery.slim.min.js"></script>
  <script src="cube-timer/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
